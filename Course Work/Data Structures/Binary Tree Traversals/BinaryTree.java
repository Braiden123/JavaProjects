 ...
 * This class has been updated so that nodes
 * can contain fields for it's position
 * in a pre-order, in-order, and post-order
 * traversals.
 * 
 * 
...
public class BinaryTree {
	...
	/**
	 * Use recursion to traverse the tree and return
	 * the size of the tree or subtree.
	 * @param u Root of the tree or subtree.
	 * @return Size of the tree or subtree.
	 */
	public static int size(Node u) {
		if (u == null) {
			return 0;
		}
